      ...
      <div className="flex w-full justify-start">
        ...
        >
          ...
          <div className="font-bai_jamjuree font-semibold flex gap-5">
            <Link to={"Login"}><button className="text-primary w-28 h-11 text-center rounded-lg">Log In</button></Link>
            <Link to={"Register"}><button className="bg-primary text-white w-28 h-11 text-center rounded-md">Get Started</button></Link>
          </div>
        </nav>
      </div>
    </>
