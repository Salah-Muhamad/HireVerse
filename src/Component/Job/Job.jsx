  ...
  return (
    <div className='bg-[#f4f4f4] p-8 rounded-lg h-56 relative mb-9'>
        <div className="jobtitle flex gap-4 justify-between">
            ...
            <div className="txt">
                <p className='font-sf_pro_text font-semibold text-xl'>{job.attributes.title}</p>
                <p className='text-[#0146B1] text-sm font-bai_jamjuree'>{job.attributes.companyName}</p>
            </div>
            </div>
        ...
        <p className='text-[#636363] text-lg font-sf_pro_text mt-1 font-extraboldbold'>{job.attributes.salary} $</p>
        </div>
