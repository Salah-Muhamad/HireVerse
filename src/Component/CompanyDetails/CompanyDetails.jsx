      ...
      <div className="bg-[#F6F6F6] min-h-screen">
        <div className="sec1 mb-20 w-full">
          ...
          <div className="Companydetails p-12  pe-20 ms-32 h-60 w-5/6 absolute top-48 bg-[#FFFFFF] rounded-xl">
            <div className="row1 ps-11">
              <div className="compname flex justify-between">
                <div className="name flex">
                  <img src={companyDetails.logoUrl} className="me-4" />
                  <div className="details">
                    <p className="font-sf_pro_text">{companyDetails.name}</p>
            ...
            <div className="row2 grid grid-cols-5 gap-4 mt-8">
              <div>
        ...
        <div className="sec2 grid grid-cols-3 gap-4 px-32 w-[1410px]">
          <div className="con1 col-span-2">
            ...
            <div className="mb-4">
              ...
              <div className="desc w-[760px] font-sf_pro_text font-normal text-[#474747] text-sm">
                At Microsoft, we are dedicated to empowering every person and
                organization on the planet to achieve more. Our innovative
                solutions and products, like Windows, Office, Azure, and Xbox,
                have helped shape the technology landscape. By integrating
                advanced technology and a commitment to quality, we strive to
                create a world where everyone can thrive in a connected digital
                era.
              </div>
            </div>
            <div className="benefits bg-[#ffffff] mt-8 rounded-xl px-14 py-11">
              <div className="benefitsrow mb-10 flex justify-between">
                <div className="item flex">
                  ...
                  <p className="w-56 text-[#474747] font-bai_jamjuree font-normal text-sm">
          ...
          <div className="con2 w-[495px]">
            <div className="con2header flex justify-between mb-6 ">
              <p className="font-sf_pro_text font-bold">
                Jobs From <span>Microsoft</span>
              </p>
              <p>
                <Link className="text-blue-700 underline">
                  <p className="font-sf_pro_text">View all</p>
                </Link>
              </p>
            </div>
            {jobs.map((ele) => (
