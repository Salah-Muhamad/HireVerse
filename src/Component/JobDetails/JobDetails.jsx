    ...
    <div>
      <div className="container w-10/12 m-auto bg-[#F9F9F9] p-3 mt-10" >
        ...
        <img src={line2} className='mt-8' />
            ...
            <div className="line col-span ml-3">
                <img src={line} alt="" />
            </div>
            <aside className='col-span-3 bg-slate-400 translate-y--8rem	'>
                <h3 className="time font-sf_pro_text font-bold text-lg mb-3">Full-Time</h3>
