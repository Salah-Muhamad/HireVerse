      ...
      <div className="  w-[450px] h-fit border-2 shadow-xl font-bai_jamjuree p-6 mb-8">
        <div className="flex justify-around">
          <div className="">
            ...
            <p className="text-[#0C2E82] font-medium">{job.attributes.available_to}</p>
          </div>
          <img src={Line} alt="" />
          <div className="">
            <p className="text-[#8B81D0] text-[12px] font-medium ">JOB TYPE</p>
            <p className="text-[#0C2E82] font-medium">{job.attributes.type}</p>
          </div>
          <img src={Line} alt="" />
          <div>
            ...
            <p className="text-[#0C2E82] font-medium">{job.attributes.salary} $</p>
          </div>
        </div>
